...
<html>
				...
				<div class="flex">
					...
					<div>
						<form id="contacto">
							...
							<input placeholder="Ingrese la hora a anular (día y hora):" type="text" name="HoraAnterior" required>
							...
							<div style="width:100%">
								<label>¿Deseas reagendar?</label><br>
								<input type="radio" name="Reagendar" value="1" id="r1"> <label for="r1">Sí</label><input type="radio" name="Reagendar" value="2" id="r2"> <label for="r2">No</label>
							</div>
							<div class="fecha" style="display:none">
								<div>
									<label>Día:</label>
									<input format="dd/mm/yyyy" type="date" name="NuevaHora_Fecha" required>
								</div>
								<div>
									<label>Hora:</label>
									<input placeholder="ej: 09:00" type="text" name="NuevaHora_Hora" required>
								</div>
							</div>
	...
	<?php require("../panelAdmin/inc/modulos/js/funciones_anular.php"); ?>
</html>