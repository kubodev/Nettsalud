	...
	<div class="col-md-9">
		...
		<section class="seccion">
			<form style="width:470px;" id="formProductos" method="post" enctype="multipart/form-data">
					<div class="lineaform"><label>Atributo:</label><input name="nombre" placeholder="ej: Color, Talla, Textura" maxlength="120" type="text" required/></div>
					<div class="lineaform">
				...
				require_once($dir[0]."inc/modulos/js/funciones_productoAtributo_agregar.php"); ?>
		</section>
	</div>